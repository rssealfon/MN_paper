####Find AUCs for WCGNA eigengenes (tub data)
...
with open("tub_wgcna2.mes") as textFile: 
 data_cor_neptune = [line.rstrip("\n").split(",") for line in textFile]
with open("arff_files/feature_PAT_Cohort.tub") as f: 
 target = [line.rstrip('\n').rstrip('\r') for line in f]

forest = RandomForestClassifier(n_estimators=500, max_features=100, class_weight='balanced')
